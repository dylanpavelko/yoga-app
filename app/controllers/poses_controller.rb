class PosesController < ApplicationController
  ...
  def new
    @pose = Pose.new
    @prime_poses = Pose.where(:modification_of_id => nil).where.not(id: @pose.id)
  end
  ...
  private
    ...
    def pose_params
      params.require(:pose).permit(:english_name, :sanskrit_name, :sanskrit_pronunciation, :difficulty, :modification_of_id)
    end
end
